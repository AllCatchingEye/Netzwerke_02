...
public class JsonObjectFromUrlUtil
{
   public static JsonObject getJsonObjectFromUrl( String url )
   {
      try {
          ...
          * however, for an API that requires json objects to PUT or POSTed,
          * you can generate the json easily by
          * 
          * JsonObject objectToBeSent = Json.createObjectBuilder().add("some name", "some value").build();
          * 
